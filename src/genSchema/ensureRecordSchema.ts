...
const getRecordSchemaContentV1 = (lib: string) => `import z from 'zod'
import { RecordId, StringRecordId } from '${lib}'
...
const getRecordSchemaContentV2 = (lib: string) => `import z from 'zod'
import { RecordId, StringRecordId } from '${lib}'
...
export const ensureRecordSchema = async (rootPath: string, lib = 'surrealdb', sdkVersion: 1 | 2 = 1) => {
	const content = sdkVersion === 2 ? getRecordSchemaContentV2(lib) : getRecordSchemaContentV1(lib)
